...
def printSudoku(sudoku):
    ...
    out.append(row1[0:3])
    out.append(row1[3:6])
    out.append(row1[6:10])

    print(row2[0:3],row2[3:6],row2[6:10])
    out.append(row2[0:3])
    out.append(row2[3:6])
    out.append(row2[6:10])

    print(row3[0:3],row3[3:6],row3[6:10])
    out.append(row3[0:3])
    out.append(row3[3:6])
    out.append(row3[6:10])

    print('')
    print(row4[0:3],row4[3:6],row4[6:10])
    out.append(row4[0:3])
    out.append(row4[3:6])
    out.append(row4[6:10])

    print(row5[0:3],row5[3:6],row5[6:10])
    out.append(row5[0:3])
    out.append(row5[3:6])
    out.append(row5[6:10])

    print(row6[0:3],row6[3:6],row6[6:10])
    out.append(row6[0:3])
    out.append(row6[3:6])
    out.append(row6[6:10])

    print('')
    print(row7[0:3],row7[3:6],row7[6:10])
    out.append(row7[0:3])
    out.append(row7[3:6])
    out.append(row7[6:10])

    print(row8[0:3],row8[3:6],row8[6:10])
    out.append(row8[0:3])
    out.append(row8[3:6])
    out.append(row8[6:10])

    print(row9[0:3],row9[3:6],row9[6:10])
    out.append(row9[0:3])
    out.append(row9[3:6])
    out.append(row9[6:10])

    u = [row1[i] for i in range(9)]
    d = [row2[i] for i in range(9)]
    t = [row3[i] for i in range(9)]
    q = [row4[i] for i in range(9)]
    c = [row5[i] for i in range(9)]
    s = [row6[i] for i in range(9)]
    se = [row7[i] for i in range(9)]
    h = [row8[i] for i in range(9)]
    n = [row9[i] for i in range(9)]
    ...
    ma_liste_json = json.dumps(CACA)

    # Encoder le JSON en base64
    ma_liste_base64 = base64.b64encode(ma_liste_json.encode('utf-8')).decode('utf-8')

    url = f"http://www.reusteur.org/sudoku/index.php?grille={ma_liste_base64}"

    print(url)

    dict_returned = {"url": url, "list": CACA}
