...
CREATE TABLE LoLGamesTracker (
    ...
    last_game_id TEXT NOT NULL DEFAULT '0',
    champions_mastery TEXT DEFAULT '{}'
);
UPDATE LoLGamesTracker SET last_game_id = '0' WHERE puuid = 'NA';

CREATE TABLE LoLChampionsMastery (
    id INTEGER PRIMARY KEY,
    champion_id INTEGER NOT NULL,
    puuid TEXT NOT NULL,
    mastery_level INTEGER NOT NULL,
    mastery_points INTEGER NOT NULL,
    points_since_last_level INTEGER NOT NULL,
    points_until_next_level INTEGER NOT NULL
);
